...
@Mod("compressed_barrels")
public class CompressedBarrelsMod {
	public static final Logger LOGGER = LogManager.getLogger(CompressedBarrelsMod.class);
	...
	public CompressedBarrelsMod() {
		CompressedBarrelsModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		CompressedBarrelsModBlocks.REGISTRY.register(bus);
		CompressedBarrelsModItems.REGISTRY.register(bus);

		CompressedBarrelsModBlockEntities.REGISTRY.register(bus);
